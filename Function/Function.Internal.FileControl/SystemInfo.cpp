...
void SystemInfoUtils::LPCWSTR2CString( LPCWSTR strW, LPCTSTR str )   
{   
#ifdef UNICODE   
...
void SystemInfoUtils::Unicode2CString( UNICODE_STRING* strU, LPCTSTR str )   
{   
	if ( *(DWORD*)strU != 0 )   
...
BOOL SystemInfoUtils::GetFsFileName( LPCTSTR lpDeviceFileName, LPCTSTR fsFileName )   
{   
	BOOL rc = FALSE;   
...
BOOL SystemInfoUtils::GetDeviceFileName( LPCTSTR lpFsFileName, LPCTSTR deviceFileName )   
{   
	BOOL rc = FALSE;   
	TCHAR lpDrive[3];   
...
BOOL SystemHandleInformation::GetTypeToken( HANDLE h, LPCTSTR str, DWORD processId )   
{   
	ULONG size = 0x2000;   
	UCHAR* lpBuffer = NULL;   
	BOOL ret = FALSE;   
...
BOOL SystemHandleInformation::GetName( HANDLE handle,LPCTSTR str, DWORD processId )   
{   
	WORD type = 0;   
...
BOOL SystemHandleInformation::GetNameByType( HANDLE h, WORD type, LPCTSTR str, DWORD processId )   
{   
	ULONG size = 0x2000;   
	UCHAR* lpBuffer = NULL;   
	BOOL ret = FALSE;   
...
BOOL SystemHandleInformation::GetProcessPath( HANDLE h, LPCTSTR strPath, DWORD remoteProcessId )   
{   
...
BOOL SystemHandleInformation::GetFileName( HANDLE h, LPCTSTR str, DWORD processId )   
{   
	BOOL ret= FALSE;   
	HANDLE hThread = NULL;   
