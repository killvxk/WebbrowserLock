...
public: 
	...
	static void LPCWSTR2CString( LPCWSTR strW, LPCTSTR str ); 
	// From unicode string to CString 
	static void Unicode2CString( UNICODE_STRING* strU, LPCTSTR str ); 

	////////////////////////////////////////////////////////////////////////////////// 
	// File name conversion functions 

	static BOOL GetDeviceFileName( LPCTSTR, LPCTSTR ); 
	static BOOL GetFsFileName( LPCTSTR,LPCTSTR ); 
...
public: 
	//Map< DWORD, DWORD&, SYSTEM_PROCESS_INFORMATION*, SYSTEM_PROCESS_INFORMATION*> m_ProcessInfos; 
...
public: 
	...
	static BOOL GetTypeToken( HANDLE, LPCTSTR, DWORD processId = GetCurrentProcessId() ); 
	static BOOL GetTypeFromTypeToken( LPCTSTR typeToken, WORD& type ); 
	static BOOL GetNameByType( HANDLE, WORD, LPCTSTR str, DWORD processId = GetCurrentProcessId()); 
	static BOOL GetName( HANDLE, LPCTSTR, DWORD processId = GetCurrentProcessId() ); 
	...
	static BOOL GetProcessPath( HANDLE h, LPCTSTR strPath, DWORD processId = GetCurrentProcessId()); 

	//File related functions 
	static BOOL GetFileName( HANDLE, LPCTSTR, DWORD processId = GetCurrentProcessId() ); 
