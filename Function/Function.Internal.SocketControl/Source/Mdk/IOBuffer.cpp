 ...
 */
unsigned char* IOBuffer::PrepareBuffer(unsigned long uRecvSize)
{
 ...
 */
void IOBuffer::WriteFinished(unsigned long uLength)
{
 ...
 *	否则失败，返回false
 */
bool IOBuffer::ReadData( unsigned char *data, unsigned long uLength, bool bDel )
{
